      ...
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View style={styles.emptyContainer}>
            <Icon name="image" size={48} color={theme.colors.textMuted} style={{ opacity: 0.3 }} />
...
const styles = StyleSheet.create({
  ...
  filterTabActive: { backgroundColor: '#000080' },
  filterTabText: { fontSize: 13, color: '#475569', fontFamily: theme.typography.fontFamily.bold },
  filterTabActiveText: { color: '#fff' },

  scrollList: { padding: 16 },
  row: { justifyContent: 'space-between' },
  sectionHeader: { fontSize: 15, fontFamily: theme.typography.fontFamily.heading, color: '#1e293b', textTransform: 'uppercase', letterSpacing: 0.5, marginTop: 8, marginBottom: 12 },
  ...
  featuredTitle: { fontSize: 18, color: '#0F172A', fontFamily: theme.typography.fontFamily.heading },
  featuredDesc: { fontSize: 13, color: '#475569', fontFamily: theme.typography.fontFamily.medium, marginTop: 4, lineHeight: 18 },
  ...
  gridTitle: { fontSize: 13, color: '#1e293b', fontFamily: theme.typography.fontFamily.heading },
  gridDesc: { fontSize: 11, color: '#64748b', fontFamily: theme.typography.fontFamily.medium, marginTop: 2 },

  emptyContainer: { paddingVertical: 48, alignItems: 'center' },
  emptyText: { fontSize: 13, color: '#64748b', fontFamily: theme.typography.fontFamily.medium, marginTop: 8 },
  ...
  modalTitle: { fontSize: 18, color: '#fff', fontFamily: theme.typography.fontFamily.bold },
  modalDesc: { fontSize: 14, color: '#cbd5e1', fontFamily: theme.typography.fontFamily.medium, marginTop: 6, lineHeight: 20 }
});
