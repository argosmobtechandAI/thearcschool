          ...
          <form onSubmit={handleAddCategory} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <div>
              ...
              <input 
                ...
                placeholder="e.g. Details about this expense"
                style={{ width: "100%", padding: "0.5rem" }}
              />
            </div>
            <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "0.5rem" }}>
              <button type="submit" disabled={isSubmitting} className="btn-primary" style={{ background: "#ef4444", color: "white", border: "none", padding: "0.5rem 1.5rem" }}>
              ...
              categories.map(c => (
                <div key={c.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "1rem", border: "1px solid var(--glass-border)", borderRadius: "8px", background: "white" }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: "0.75rem", color: "#ef4444", marginTop: "4px", fontWeight: "600", display: "flex", alignItems: "center", gap: "0.5rem" }}>
                      <span>{c.type}</span>
