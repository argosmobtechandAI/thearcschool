        ...
        <div className="glass-panel" style={{ padding: "2rem", '@media print': { border: 'none', boxShadow: 'none' } }}>
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <p style={{ color: "var(--text-secondary)", fontSize: "0.875rem" }}>
              Period: {globalDateRange.startDate ? new Date(globalDateRange.startDate).toLocaleDateString() : 'Start'} to {globalDateRange.endDate ? new Date(globalDateRange.endDate).toLocaleDateString() : 'End'}
            </p>
          </div>
