...
export const updateMarks = async (req, res) => {
  try {
    ...
    await UserService.updateMarks(data);
...
export const updateAttendance = async (req, res) => {
  try {
    ...
    await UserService.updateAttendance(id, data);
...
export const bulkUpdateAttendance = async (req, res) => {
  try {
    ...
    await UserService.bulkUpdateAttendance(data);
...
export const getAttendance = async (req, res) => {
  try {
    ...
    const records = await UserService.getAttendance(startDate, endDate, classId);
...
export const submitFees = async (req, res) => {
  try {
    ...
    await UserService.submitFees(studentId, feeId, data);
...
export const getTopper = async (req, res) => {
  try {
    const { topper, score } = await UserService.getTopper();
